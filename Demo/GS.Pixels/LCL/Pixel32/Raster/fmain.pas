...
type
  ...
  public
    ...
    procedure drawQuad(const vertices : TQuadVertices; const _color : TP32 = $FF000000);
    procedure drawQuadBorder(const vertices : TQuadVertices; const _color : TP32 = $FF000000);
    procedure drawQuads;
  end;
...
function TForm1.buildQuad(len,cx,cy,angleInDegree : Integer) : TQuadVertices;
...
procedure TForm1.drawQuad(const vertices : TQuadVertices; const _color: TP32);
begin
  //Draw 2 triangles for the quad. (clockwise !)
  pixel.color_pen := _color;
...
procedure TForm1.drawQuadBorder(const vertices: TQuadVertices; const _color: TP32);
begin
...
begin
  ...
  pixel.CopyToDc(tp.Canvas.Handle,0,0);
end;
